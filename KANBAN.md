...
- [x] **Automate TLS cert cycling** — weekly CronJob renews DuckDNS Let's Encrypt cert (apex + wildcard) via DNS-01; first run 2026-04-22 14:18 MT, recurring Wed 14:18 MT
