...
public static class FuzzySearchService
{
    ...
    private static readonly Dictionary<string, List<string>> SynonymMap = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["parks"] = ["Outdoors"],
        ["nature"] = ["Outdoors"],
        ["hike"] = ["Outdoors", "Fitness & Sports"],
        ["hiking"] = ["Outdoors", "Fitness & Sports"],
        ["camping"] = ["Outdoors"],
        ["trail"] = ["Outdoors"],
        ["trails"] = ["Outdoors"],
        ["outside"] = ["Outdoors"],
        ...
        ["movie"] = ["Arts & Culture", "Attractions"],
        ["movies"] = ["Arts & Culture", "Attractions"],
        ["cinema"] = ["Arts & Culture", "Attractions"],
        ["film"] = ["Arts & Culture"],
        ...
        ["soccer"] = ["Fitness & Sports"],
        ["tennis"] = ["Fitness & Sports"],
        ["bowling"] = ["Fitness & Sports", "Attractions"],
        ...
        ["books"] = ["Shopping", "Education"],
        ["bookstore"] = ["Shopping", "Education"],
        ["buy"] = ["Shopping"],
        ["retail"] = ["Shopping"],
        ...
        ["haircut"] = ["Wellness & Beauty"],
        ["nails"] = ["Wellness & Beauty"],
        ["facial"] = ["Wellness & Beauty"],
        ["beauty"] = ["Wellness & Beauty"],
        ["wellness"] = ["Wellness & Beauty"],
        ["relax"] = ["Wellness & Beauty"],
        ["relaxation"] = ["Wellness & Beauty"],
        ["pedicure"] = ["Wellness & Beauty"],
        ["manicure"] = ["Wellness & Beauty"],
